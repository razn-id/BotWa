...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
  try {
    ...
    const groupMetadata = m.isGroup
      ? await hisoka.groupMetadata(m.chat).catch((e) => {})
      : "";
    ...
    if (db.data.settings[botNumber].autobio) {
      ...
      if (new Date() * 1 - setting.status > 1000) {
        ...
        await hisoka.updateProfileStatus(
          `${hisoka.user.name} | Runtime : ${runtime(uptime)}`
        );
    ...
    if (db.data.chats[m.chat].antilink) {
      if (budy.match(`chat.whatsapp.com`)) {
        ...
        let gclink =
          `https://chat.whatsapp.com/` + (await hisoka.groupInviteCode(m.chat));
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`;
      ...
      if (room.x !== room.o)
        await hisoka.sendText(room.x, str, m, { mentions: parseMention(str) });
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`;
          this.suit[id] = {
            ...
            waktu: setTimeout(() => {
              if (this.suit[id])
                hisoka.sendText(m.chat, `_Waktu suit habis_`, m);
              delete this.suit[id];
            }, 60000),
            poin,
            poin_lose,
      ...
      case "donate":
        {
          hisoka.sendMessage(
            ...
            {
              image: {
                url: "https://telegra.ph/file/74fd634010128be37972c.jpg",
              },
      ...
      case "tebak":
        {
          ...
          if (args[0] === "lagu") {
            ...
            let msg = await hisoka.sendMessage(
              m.chat,
      ...
      case "stikermeme":
        {
          ...
          let smeme = `https://api.memegen.link/images/custom/${encodeURIComponent(
            atas
          )}/${encodeURIComponent(bawah)}.png?background=${fatGans.result.url}`;
      ...
      case "simisimi":
        {
          if (!text) throw `Example : ${prefix + command} text`;
          hm = await fetchJson(
            api("zenz", "/api/simisimi", { text: text }, "apikey")
          );
      ...
      case "jooxdl":
        {
          ...
          let msg = await hisoka.sendImage(
            m.chat,
            anu.result.img,
...
1 - 5362`;
          ...
          try {
            let res = await fetchJson(
              `https://fatiharridho.herokuapp.com/api/islamic/hadits?list=${args[0]}`
            );
            let { number, arab, id } = res.result.find(
              (v) => v.number == args[1]
            );
            m.reply(`No. ${number}
      ...
      case "playstore":
        {
          ...
          let res = await fetchJson(
            api("zenz", "/webzone/playstore", { query: text }, "apikey")
          );
      ...
      case "gsmarena":
        {
          ...
          let res = await fetchJson(
            api("zenz", "/webzone/gsmarena", { query: text }, "apikey")
          );
          let {
            judul,
            rilis,
...
⭔ Detail: ${detail}`;
      ...
      case "jadwalbioskop":
        {
          ...
          let res = await fetchJson(
            api("zenz", "/webzone/jadwalbioskop", { kota: text }, "apikey")
          );
      ...
      case "nowplayingbioskop":
        {
          let res = await fetchJson(
            api("zenz", "/webzone/nowplayingbioskop", {}, "apikey")
          );
      ...
      case "aminio":
        {
          ...
          let res = await fetchJson(
            api("zenz", "/webzone/amino", { query: text }, "apikey")
          );
          ...
          hisoka.sendImage(
            m.chat,
            "https://" + res.result[0].community_thumb,
            capt,
            m
          );
        }
      ...
      case "wattpad":
        {
          ...
          let res = await fetchJson(
            api("zenz", "/webzone/wattpad", { query: text }, "apikey")
          );
          let { judul, dibaca, divote, bab, waktu, url, thumb, description } =
            res.result[0];
      ...
      case "webtoons":
        {
          if (!text) throw `Example : ${prefix + command} love`;
          let res = await fetchJson(
            api("zenz", "/webzone/webtoons", { query: text }, "apikey")
          );
      ...
      case "drakor":
        {
          if (!text) throw `Example : ${prefix + command} love`;
          let res = await fetchJson(
            api("zenz", "/webzone/drakor", { query: text }, "apikey")
          );
            ...
            let sections = [
              {
                ...
                rows: [
                  ...
                  },
                  {
                    ...
                    description: `Change menu bot to Template Location`,
                  },
                ],
              },
            ];
